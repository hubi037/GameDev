...
template<> DebugDisplay* Ogre::Singleton<DebugDisplay>::msSingleton = 0;
DebugDisplay* DebugDisplay::getSingletonPtr(void)
{
    return msSingleton;
}
 
DebugDisplay& DebugDisplay::getSingleton(void)
{  
    assert( msSingleton );  return ( *msSingleton );  
}


DebugDisplay::DebugDisplay(Ogre::SceneManager *_sceneManager, float _fillAlpha)
...
void DebugDisplay::setIcoSphereRecursionLevel(int recursionLevel)
{
...
void DebugDisplay::buildLine(const Ogre::Vector3& start,
...
void DebugDisplay::buildQuad(const Ogre::Vector3 *vertices,
                          const Ogre::ColourValue& colour,
                          float alpha)
{
...
void DebugDisplay::buildCircle(const Ogre::Vector3 &centre,
                                                          float radius,
                                  int segmentsCount,
                                                          const Ogre::ColourValue& colour,
                                                          float alpha)
...
void DebugDisplay::buildFilledCircle(const Ogre::Vector3 &centre,
                                                          float radius,
                                  int segmentsCount,
                                                          const Ogre::ColourValue& colour,
                                                          float alpha)
...
void DebugDisplay::buildCylinder(const Ogre::Vector3 &centre,
                                                          float radius,
                                  int segmentsCount,
                                                          float height,
                                                          const Ogre::ColourValue& colour,
...
void DebugDisplay::buildFilledCylinder(const Ogre::Vector3 &centre,
                                                          float radius,
                                  int segmentsCount,
                                                          float height,
                                                          const Ogre::ColourValue& colour,
...
void DebugDisplay::buildCuboid(const Ogre::Vector3 *vertices,
                                                          const Ogre::ColourValue& colour,
                                                          float alpha)
{
    int index = addLineVertex(vertices[0], Ogre::ColourValue(colour.r, colour.g, colour.b, alpha));
...
void DebugDisplay::buildFilledCuboid(const Ogre::Vector3 *vertices,
                                                          const Ogre::ColourValue& colour,
                                                          float alpha)
{
...
void DebugDisplay::buildFilledQuad(const Ogre::Vector3 *vertices,
                                  const Ogre::ColourValue& colour,
                                  float alpha)
{
    int index = addTriangleVertex(vertices[0], Ogre::ColourValue(colour.r, colour.g, colour.b, alpha));
...
void DebugDisplay::buildFilledTriangle(const Ogre::Vector3 *vertices,
                                                                          const Ogre::ColourValue& colour,
                                                                          float alpha)
{
    int index = addTriangleVertex(vertices[0], Ogre::ColourValue(colour.r, colour.g, colour.b, alpha));
...
void DebugDisplay::buildTetrahedron(const Ogre::Vector3 &centre,
                                       float scale,
                                                                   const Ogre::ColourValue &colour,
                                                                   float alpha)
{
...
void DebugDisplay::buildFilledTetrahedron(const Ogre::Vector3 &centre,
                                                                                 float scale,
                                                                                 const Ogre::ColourValue &colour,
                                                                                 float alpha)
{
...
void DebugDisplay::drawLine(const Ogre::Vector3& start,
                     const Ogre::Vector3& end,
                     const Ogre::ColourValue& colour)
{
...
void DebugDisplay::drawCircle(const Ogre::Vector3 &centre,
                                 float radius,
                                                         int segmentsCount,
                                                         const Ogre::ColourValue& colour,
                                                         bool isFilled)
...
void DebugDisplay::drawCylinder(const Ogre::Vector3 &centre,
                                 float radius,
                                                         int segmentsCount,
                                                         float height,
                                                         const Ogre::ColourValue& colour,
...
void DebugDisplay::drawQuad(const Ogre::Vector3 *vertices,
                     const Ogre::ColourValue& colour,
                     bool isFilled)
{
...
void DebugDisplay::drawCuboid(const Ogre::Vector3 *vertices,
                       const Ogre::ColourValue& colour,
                      bool isFilled)
{
...
void DebugDisplay::drawSphere(const Ogre::Vector3 &centre,
                             float radius,
                             const Ogre::ColourValue& colour,
                             bool isFilled)
{
...
void DebugDisplay::drawTetrahedron(const Ogre::Vector3 &centre,
                                                                  float scale,
                                                                  const Ogre::ColourValue& colour,
                                                                  bool isFilled)
{
...
int DebugDisplay::addLineVertex(const Ogre::Vector3 &vertex, const Ogre::ColourValue &colour)
{
    lineVertices.push_back(VertexPair(vertex, colour));
    return linesIndex++;
}
 
void DebugDisplay::addLineIndices(int index1, int index2)
{
    lineIndices.push_back(index1);
    lineIndices.push_back(index2);
}
 
int DebugDisplay::addTriangleVertex(const Ogre::Vector3 &vertex, const Ogre::ColourValue &colour)
{
        triangleVertices.push_back(VertexPair(vertex, colour));
        return trianglesIndex++;
}
 
void DebugDisplay::addTriangleIndices(int index1, int index2, int index3)
{
...
void DebugDisplay::addQuadIndices(int index1, int index2, int index3, int index4)
{
        triangleIndices.push_back(index1);
        triangleIndices.push_back(index2);
        triangleIndices.push_back(index3);
