#ifndef __DebugDisplay_h_
#define __DebugDisplay_h_
...
class DebugDisplay : public Ogre::Singleton<DebugDisplay>
{
public:
        DebugDisplay(Ogre::SceneManager *_sceneManager, float _fillAlpha);
        ~DebugDisplay();

        static DebugDisplay& getSingleton(void);
        static DebugDisplay* getSingletonPtr(void);
